...
public class ThemeSettingViewModel : MyReactiveObject
{
    ...
    private void ModifyFontSize()
    {
        ...
        style.Add(new Setter { Property = TemplatedControl.FontSizeProperty, Value = size });
    ...
    private void ModifyFontFamily()
    {
        ...
        try
        {
            ...
            {
                Property = TemplatedControl.FontFamilyProperty, Value = new FontFamily(currentFontFamily)
            });
            Application.Current?.Styles.Add(style);
        }
        catch (Exception ex)
