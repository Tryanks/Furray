...
public partial class BackupAndRestoreView : ReactiveUserControl<BackupAndRestoreViewModel>
{
    ...
    public BackupAndRestoreView(Window window)
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.Bind(ViewModel, vm => vm.SelectedSource.UserName, v => v.txtWebDavUserName.Text)
                .DisposeWith(disposables);
            this.Bind(ViewModel, vm => vm.SelectedSource.Password, v => v.txtWebDavPassword.Text)
                .DisposeWith(disposables);
            this.Bind(ViewModel, vm => vm.SelectedSource.DirName, v => v.txtWebDavDirName.Text)
                .DisposeWith(disposables);
